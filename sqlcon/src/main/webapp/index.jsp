  ...
  <body>
    <div class="main-block">
      ...
      -->
        ...
        <form action="loginformcontroller" method ="get">
        	<label for="drop-down">Actions:</label>
                 <select name="action" id="drop-down">
        	...
        	<input type="text" name="Name" id="name" placeholder="Name" required/>
        	<input type="password" name="password" id="name" placeholder="Password" required/>
        	<label id="icon" for="id"> enter the id number you want to delete  </label>
        	<input type="text" name="id" id="name" placeholder="Password" required/>
